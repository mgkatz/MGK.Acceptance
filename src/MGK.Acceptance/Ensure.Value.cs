	...
	public static partial class Ensure
	{
		...
		public static class Value
		{
			...
			public static void IsNotNull(object value)
				=> IsNotNull<Exception>(value, Resources.AppMessages.ErrorNull);
			...
			public static void IsNotNull<T>(object value)
				where T : Exception
					=> IsNotNull<T>(value, Resources.AppMessages.ErrorNull);
			...
			public static void IsNotNullNorEmpty(string value)
				=> IsNotNullNorEmpty<Exception>(value, Resources.AppMessages.ErrorNullNorEmpty);
			...
			public static void IsNotNullNorEmpty<T>(string value)
				where T : Exception
					=> IsNotNullNorEmpty<T>(value, Resources.AppMessages.ErrorNullNorEmpty);
			...
			public static void IsNotNullNorEmpty<TValue>(IEnumerable<TValue> value)
				=> IsNotNullNorEmpty<Exception, TValue>(value, Resources.AppMessages.ErrorNullNorEmpty);
			...
			public static void IsNotNullNorEmpty<T, TValue>(IEnumerable<TValue> value)
				where T : Exception
					=> IsNotNullNorEmpty<T, TValue>(value, Resources.AppMessages.ErrorNullNorEmpty);
			...
			public static void IsNotNullNorEmptyNorWhiteSpace(string value)
				=> IsNotNullNorEmptyNorWhiteSpace<Exception>(value, Resources.AppMessages.ErrorNullNorEmptyNorWhiteSpace);
			...
			public static void IsNotNullNorEmptyNorWhiteSpace<T>(string value)
				where T : Exception
					=> IsNotNullNorEmptyNorWhiteSpace<T>(value, Resources.AppMessages.ErrorNullNorEmptyNorWhiteSpace);
		...
		private static void ValidateErrorMessage(string errorMessage)
		{
			if (errorMessage.IsNullOrEmptyOrWhiteSpace())
				Raise.Error.Parameter(nameof(errorMessage), Resources.AppMessages.ErrorMessageNotProvided);
		}
	}
}
